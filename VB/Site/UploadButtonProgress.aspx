<%@ Page Language="vb" AutoEventWireup="true" CodeFile="UploadButtonProgress.aspx.vb"
	Inherits="UploadControl_UploadButtonProgress" %>
				...
				<tr>
					<td class="uploadControlCell" style="height: 82px">
						<dxuc:ASPxUploadControl ID="uc" ClientInstanceName="uploadControl" runat="server">
							<ClientSideEvents UploadingProgressChanged="OnUploadProgressChanged" FileUploadComplete="OnFileUploadComplete"
